				...
				if(isSpriteHover(button[i][j].sprite.getGlobalBounds(), sf::Vector2f(event.mouseButton.x, event.mouseButton.y)) == true)
 	        		{
						...
						if (i == 0) {
							for (int j1 = 0; j1 < n; j1++) {
								...
								button[0][j1].set_bn(0);
								button[0][j1].set_num(0);
								button[0][j1].set_par(0);
						...
						if (i == N - 1) {
							for (int j1 = 0; j1 < n; j1++) {
								...
								button[n - 1][j1].set_bn(0);
								button[n - 1][j1].set_num(0);
								button[n - 1][j1].set_par(0);
						...
						if (j == 0) {
							for (int i1 = 0; i1 < n; i1++) {
								...
								button[i1][0].set_bn(0);
								button[i1][0].set_num(0);
								button[i1][0].set_par(0);
						...
						if (j == N - 1) {
							for (int i1 = 0; i1 < n; i1++) {
								...
								button[i1][n - 1].set_bn(0);
								button[i1][n - 1].set_num(0);
								button[i1][n - 1].set_par(0);
		...
		if(isSpriteHover(sprite11.getGlobalBounds(), sf::Vector2f(event.mouseButton.x, event.mouseButton.y)) == true)
               {
				...
				for (int i = 0; i < n; i++) {
						...
						//window.display();
		                	...
		                	//вот здесь создается новый столбей/строка, изменить параметры на новые
		                	button[i][0].image1.loadFromFile("but.png");
		                	button[i][0].set_bn(0);
		                	button[i][0].set_num(0);
		                	button[i][0].set_par(0);
		                	button[i][0].set_what(0);
		                	button[i][0].texture1.loadFromImage(button[i][0].image1);
					button[i][0].sprite.setTexture(button[i][0].texture1);
					//window.draw(button[i][0].sprite);
					//window.display();
		                }
		         }												
		...
		if(isSpriteHover(sprite2.getGlobalBounds(), sf::Vector2f(event.mouseButton.x, event.mouseButton.y)) == true)
               {
				...
				for (int i = 0; i < n; i++) {
						...
						//window.display();
		                	...
		                	//вот здесь создается новый столбей/строка, изменить параметры на новые
		                	button[i][n - 1].image1.loadFromFile("but.png");
		                	button[i][n - 1].set_bn(0);
		                	button[i][n - 1].set_num(0);
		                	button[i][n - 1].set_par(0);
		                	button[i][n - 1].set_what(0);
		                	button[i][n - 1].texture1.loadFromImage(button[i][n - 1].image1);
					button[i][n - 1].sprite.setTexture(button[i][n - 1].texture1);
					//window.draw(button[i][0].sprite);
					//window.display();
		                }
		         }												
